...
#
# Script generated by Vivado on Mon Mar 09 13:57:11 +0800 2026
...
export RDI_DATADIR="D:/VIVADO/APPDATA/Vivado/2024.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/VIVADO/APPDATA/Vivado/2024.2/data/xsim"
  fi
